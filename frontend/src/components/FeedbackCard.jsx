...
const FeedbackCard = ({ content, name, title, img }) => (
  <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card hover:bg-white scroll-px-px">
    ...
    <div className="flex flex-col ml-4">
      ...
      <p className="font-poppins font-normal text-[16px] leading-[24px] bg-dimWhite ">
