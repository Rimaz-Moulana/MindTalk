    ...
    return (
        <div className="sky bg-white h-screen">
            <div className="absolute top-0 left-0 w-full h-full">
                <div className="content absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-blue-500 z-10"></div>
                <div className="content absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-blue-500 z-10">
                    {currentQuestion >= 0 && (
                        <div className="progress-bar w-280 h-2 bg-gray-200 rounded-full mb-6">
                            <div className="progress bg-blue-500 h-full rounded-full" style={{ width: `${progress}%` }}></div>
                        </div>
                    )}
