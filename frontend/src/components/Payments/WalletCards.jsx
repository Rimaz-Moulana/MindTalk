...
export default function WalletCards() {
  ...
  // Function to handle card click and change the active card
    ...
    <div className="grid grid-cols-3 gap-4 grid-row-2 gap-1">
      ...
      <div
        className={`col-span-1 row-span-1 ${
          activeCard === 2 ? 'border border-blue-500' : ''
        }`}
        onClick={() => handleCardClick(2)}
      >
        <div className={`bg-white rounded-xl shadow-md overflow-hidden text-center p-5 h-40 flex flex-col justify-between ${
          activeCard === 2 ? 'text-blue-500' : 'text-black'
        }`}>
          <div className="icon-container relative">
      ...
      <div
        className={`col-span-1 row-span-1 ${
          activeCard === 3 ? 'border border-blue-500' : ''
        }`}
        onClick={() => handleCardClick(3)}
      >
        <div className={`bg-white rounded-xl shadow-md overflow-hidden text-center p-5 h-40 flex flex-col justify-between ${
          activeCard === 3 ? 'text-blue-500' : 'text-black'
        }`}>
          <div className="icon-container relative">
