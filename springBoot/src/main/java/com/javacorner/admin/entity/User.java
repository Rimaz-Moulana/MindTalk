...
public class User {
    ...
    @OneToOne(mappedBy = "professional_counselor")
    private ProfessionalCounselor professionalCounselor;

    @OneToOne(mappedBy = "volunteer_counselor")
    private VolunteerCounselor volunteerCounselor;
